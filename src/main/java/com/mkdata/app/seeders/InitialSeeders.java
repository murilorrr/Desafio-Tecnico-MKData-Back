...
public class InitialSeeders implements CommandLineRunner{
  ...
  private void loadCustomerData() {
    ...
    Customer c1 = new Customer(null, "Jorge", "cpf", "254.241.332-32", "32.332.332-22", LocalDate.now(), true, groups.get(0));
    Customer c2 = new Customer(null, "Fernanda", "cpf", "333.525.737-22", "12.231.425-41", LocalDate.now(), true, groups.get(1));
    Customer c3 = new Customer(null, "Klaus", "cpf", "515.647.858-65", "55.775.325-66", LocalDate.now(), false, groups.get(2));
